...
public class DsCommonFlowController extends BaseController
{
	...
	{
		return "/manage/flow/addFlowXML.jsp";
	}
	...
	{
		return "/manage/flow/getFlowDataTableRwx.jsp";
	}
	
	@RequestMapping("/getFlowDataTable")
	public String getFlowDataTable()
	{
		return "/manage/flow/getFlowDataTable.jsp";
	}
	...
	public String updFlow1()
	{
		...
		put("po", po);
		put("taskMap", taskMap);
		return "/manage/flow/updFlowXML.jsp";
	}
	...
	public String getFlow()
	{
		...
		if (categoryid > 0)
		{
			...
			if (po != null)
			{
				...
				return "/manage/flow/getFlow.jsp";
			}
		}
		return null;
	}
	...
	public String getFlowById()
	{
		...
		return "/manage/flow/getFlowById.jsp";
	}
	...
	public String addFlowCategory1()
	{
		...
		put("parent", parent);
		put("pid", pid);
		return "/manage/flow/addFlowCategory.jsp";
	}
	...
	public String updFlowCategory1()
	{
		...
		put("po", po);
		put("parent", parent);
		return "/manage/flow/updFlowCategory.jsp";
	}
	...
	public String updFlowCategorySeq1()
	{
		...
		put("list", list);
		return "/manage/flow/updFlowCategorySeq.jsp";
	}
	...
	public String updFlowCategoryMove1()
	{
		...
		put("rootid", rootid);
		return "/manage/flow/updFlowCategoryMove.jsp";
	}
	...
	public String getFlowCategoryTree()
	{
		...
		put("po", po);
		return "/manage/flow/getFlowCategoryTree.jsp";
	}
	...
	public String getFlowCategory()
	{
		...
		put("rootid", rootid);
		put("pid", pid);
		return "/manage/flow/getFlowCategory.jsp";
	}
	...
	public String getFlowCategoryById()
	{
		...
		DsCommonFlowCategory po = service.get(id);
		put("po", po);
		return "/manage/flow/getFlowCategoryById.jsp";
	}
